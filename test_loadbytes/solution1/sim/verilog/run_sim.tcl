...
if {[file isfile load_test_h.autotvin.dat]} {
	file delete -force load_test_h.autotvin.dat
}

if {[file isfile load_test_h.autotvout.dat]} {
	file delete -force load_test_h.autotvout.dat
}
