...
// ==============================================================
# 1 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c"
# 1 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
# 4 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/constants.h" 2
# 2 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
# 3 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
# 4 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
# 7 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
# 8 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c" 2
...
void init_buffer(volatile unsigned char *buffer, unsigned long long int numbytes) {
...
extern "C"
#endif
void apatb_load_test_h_sw(volatile unsigned char *, volatile unsigned char *, volatile unsigned long long *);
# 37 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c"
int generate_test_vectors() {
 unsigned char key[16];
 unsigned char nonce[16];
    unsigned long long int count, ret_val = 0;
...
#ifndef HLS_FASTSIM
#define load_test_h apatb_load_test_h_sw
#endif
# 47 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c"
...
# 47 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c"
 ...
 if(memcmp(c_state, h_state, sizeof(c_state))){
  fprintf((&__iob_func()[1]),"Caccaculomerda\n");
  return 1;
 }
    fprintf((&__iob_func()[1]),"No errors\n");
    return 0;
}
#endif
# 57 "H:/home/Documents/Git/PII-2022-Grazzani-Rogora-Zaffiretti/src-base_func/test.c"
