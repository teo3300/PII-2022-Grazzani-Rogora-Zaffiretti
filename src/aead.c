...
// Ignore warning from gcc due to explicit overflow of writing area (only logical, never happens)
...
u8 crypto_aead_decrypt(
    ...
    *mlen = clen - CRYPTO_ABYTES;
    ...
    /*compress the result in an 8-bit variable*/
    u8 compact = 0;
