...
entry:
  ...
  %10 = call i32 @apatb_crypto_aead_encrypt_hw(i8* %5, i64* %clen_copy, i8* %6, i64 %mlen, i8* %7, i64 %adlen, i8* %nsec_copy, i8* %8, i8* %9)
...
define internal fastcc void @copy_in([48 x i8]* readonly, [48 x i8]* noalias align 512, i64* readonly, i64* noalias align 512, [32 x i8]* readonly, [32 x i8]* noalias align 512, [32 x i8]* readonly, [32 x i8]* noalias align 512, i8* readonly, i8* noalias align 512, [16 x i8]* readonly, [16 x i8]* noalias align 512, [16 x i8]* readonly, [16 x i8]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([48 x i8]*, [48 x i8]* noalias readonly align 512, i64*, i64* noalias readonly align 512, [32 x i8]*, [32 x i8]* noalias readonly align 512, [32 x i8]*, [32 x i8]* noalias readonly align 512, i8*, i8* noalias readonly align 512, [16 x i8]*, [16 x i8]* noalias readonly align 512, [16 x i8]*, [16 x i8]* noalias readonly align 512) unnamed_addr #3 {
entry:
...
entry:
  %9 = bitcast i8* %0 to [48 x i8]*
  %10 = bitcast i8* %2 to [32 x i8]*
  %11 = bitcast i8* %4 to [32 x i8]*
  %12 = bitcast i8* %7 to [16 x i8]*
  %13 = bitcast i8* %8 to [16 x i8]*
  call void @copy_out([48 x i8]* null, [48 x i8]* %9, i64* null, i64* %1, [32 x i8]* null, [32 x i8]* %10, [32 x i8]* null, [32 x i8]* %11, i8* null, i8* %6, [16 x i8]* null, [16 x i8]* %12, [16 x i8]* null, [16 x i8]* %13)
  %14 = bitcast [48 x i8]* %9 to i8*
  %15 = bitcast [32 x i8]* %10 to i8*
  %16 = bitcast [32 x i8]* %11 to i8*
  %17 = bitcast [16 x i8]* %12 to i8*
  %18 = bitcast [16 x i8]* %13 to i8*
  %19 = call i32 @crypto_aead_encrypt_hw_stub(i8* %14, i64* %1, i8* %15, i64 %3, i8* %16, i64 %5, i8* %6, i8* %17, i8* %18)
  call void @copy_in([48 x i8]* null, [48 x i8]* %9, i64* null, i64* %1, [32 x i8]* null, [32 x i8]* %10, [32 x i8]* null, [32 x i8]* %11, i8* null, i8* %6, [16 x i8]* null, [16 x i8]* %12, [16 x i8]* null, [16 x i8]* %13)
  ret i32 %19
}
