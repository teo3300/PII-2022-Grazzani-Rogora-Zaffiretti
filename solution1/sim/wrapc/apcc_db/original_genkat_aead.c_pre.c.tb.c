...
signed int crypto_aead_encrypt_c( char *, signed long long *,  char *, signed long long ,  char *, signed long long ,  char *,  char *,  char *);
signed int apatb_crypto_aead_decrypt_c_sw( char *, signed long long *,  char *,  char *, signed long long ,  char *, signed long long ,  char *,  char *);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i32 @apatb_crypto_aead_decrypt_c_sw(i8* %%10, i64* %%mlen2, i8* null, i8* %%9, i64 %%28, i8* %%4, i64 %%storemerge1, i8* %%2, i8* %%1) nounwind, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_111_count);
  llvm_cbe_tmp__27 = (unsigned int )apatb_crypto_aead_decrypt_c_sw(( char *)llvm_cbe_tmp__15, (signed long long *)(&llvm_cbe_mlen2), ( char *)(( char *)/*NULL*/0), ( char *)llvm_cbe_tmp__14, llvm_cbe_tmp__26, ( char *)llvm_cbe_tmp__10, llvm_cbe_storemerge1, ( char *)llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 @crypto_aead_encrypt_c(i8* %%9, i64* %%clen, i8* %%3, i64 %%storemerge22, i8* %%4, i64 %%storemerge1, i8* null, i8* %%2, i8* %%1) nounwind, !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_85_count);
  llvm_cbe_tmp__23 = (unsigned int )crypto_aead_encrypt_c(( char *)llvm_cbe_tmp__14, (signed long long *)(&llvm_cbe_clen), ( char *)llvm_cbe_tmp__9, llvm_cbe_storemerge22, ( char *)llvm_cbe_tmp__10, llvm_cbe_storemerge1, ( char *)(( char *)/*NULL*/0), ( char *)llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge22 = 0x%I64X",llvm_cbe_storemerge22);
printf("\nArgument storemerge1 = 0x%I64X",llvm_cbe_storemerge1);
