...
signed int apatb_crypto_aead_encrypt_h_sw( char *, signed long long *,  char *, signed long long ,  char *, signed long long ,  char *,  char *,  char *, signed long long *);
signed int crypto_aead_decrypt( char *, signed long long *,  char *,  char *, signed long long ,  char *, signed long long ,  char *,  char *, signed long long *);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str11[35] = "crypto_aead_decrypt returned <%d>\n";
static  char aesl_internal__OC_str12[29] = "DECRYPT ERROR: in cycle %d:\n";
...
static  char aesl_internal__OC_str13[28] = "cycle %d: decrypt check OK\n";
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [16 x i8]* %%nonce, i64 0, i64 0, !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_35_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @init_buffer(i8* %%2, i64 16), !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_36_count);
  init_buffer(( char *)llvm_cbe_tmp__8, 16ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",16ull);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [32 x i8]* %%msg, i64 0, i64 0, !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_37_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @init_buffer(i8* %%3, i64 32), !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_38_count);
  init_buffer(( char *)llvm_cbe_tmp__9, 32ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",32ull);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [32 x i8]* %%ad, i64 0, i64 0, !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_39_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @init_buffer(i8* %%4, i64 32), !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_40_count);
  init_buffer(( char *)llvm_cbe_tmp__10, 32ull);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",32ull);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = bitcast [5 x i64]* %%c_state to i8*, !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_41_count);
  llvm_cbe_tmp__11 = ( char *)(( char *)(&llvm_cbe_c_state));
if (AESL_DEBUG_TRACE)
printf("\n  call void @init_buffer(i8* %%5, i64 40), !dbg !12 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_42_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds [32 x i8]* %%msg2, i64 0, i64 0, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_69_count);
  llvm_cbe_tmp__20 = ( char *)(&llvm_cbe_msg2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
llvm_cbe_tmp__44:
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_71_count);
  llvm_cbe_tmp__21 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__21);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds %%struct._iobuf* %%17, i64 2, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__22 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__21[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%18, i8* getelementptr inbounds ([30 x i8]* @aesl_internal_.str3, i64 0, i64 0), i8* %%7) nounwind, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_73_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__22, ( char *)((&aesl_internal__OC_str3[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 30
#endif
])), ( char *)llvm_cbe_tmp__13);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge8 = phi i64 [ 0, %%.preheader6 ], [ %%42, %%.loopexit  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_storemerge8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = phi i32 [ 1, %%.preheader6 ], [ %%22, %%.loopexit  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_75_count);
...
printf("\n = 0x%X",llvm_cbe_tmp__25);
  ...
  llvm_cbe_tmp__25__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__24;   /* for PHI node */
  llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned long long )0ull;   /* for PHI node */
  goto llvm_cbe_tmp__46;

llvm_cbe__2e_loopexit:
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = add i64 %%storemerge8, 1, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_132_count);
  llvm_cbe_tmp__41 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge8&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__41&18446744073709551615ull)));
  if ((((unsigned long long )llvm_cbe_tmp__41&18446744073709551615ULL) < ((unsigned long long )33ull&18446744073709551615ULL))) {
    llvm_cbe_storemerge8__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__41;   /* for PHI node */
...
llvm_cbe_tmp__46:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = phi i32 [ %%25, %%37 ], [ %%20, %%.preheader  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_77_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i64 [ %%41, %%37 ], [ 0, %%.preheader  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_126_count);
  llvm_cbe_tmp__37 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__37);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds %%struct._iobuf* %%38, i64 1, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_127_count);
  llvm_cbe_tmp__38 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__37[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%39, i8* getelementptr inbounds ([28 x i8]* @aesl_internal_.str13, i64 0, i64 0), i32 %%25) nounwind, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_128_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__38, ( char *)((&aesl_internal__OC_str13[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 28
#endif
])), llvm_cbe_tmp__26);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = add i64 %%storemerge1, 1, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_129_count);
  llvm_cbe_tmp__40 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge1&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__40&18446744073709551615ull)));
  llvm_cbe_tmp__25__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__26;   /* for PHI node */
  llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__40;   /* for PHI node */
  goto llvm_cbe_tmp__46;

llvm_cbe_tmp__47:
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add nsw i32 %%22, 1, !dbg !9 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_86_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%9, i8* getelementptr inbounds ([12 x i8]* @aesl_internal_.str4, i64 0, i64 0), i32 %%22) nounwind, !dbg !9 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_91_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fprint_bstr(%%struct._iobuf* %%9, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str7, i64 0, i64 0), i8* %%3, i64 %%storemerge8), !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_94_count);
  fprint_bstr((l_struct_OC__iobuf *)llvm_cbe_tmp__15, ( char *)((&aesl_internal__OC_str7[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 6
#endif
])), ( char *)llvm_cbe_tmp__9, llvm_cbe_storemerge8);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge8 = 0x%I64X",llvm_cbe_storemerge8);
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @fprint_bstr(%%struct._iobuf* %%9, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str8, i64 0, i64 0), i8* %%4, i64 %%storemerge1), !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_95_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 @crypto_aead_encrypt_c(i8* %%11, i64* %%cclen, i8* %%3, i64 %%storemerge8, i8* %%4, i64 %%storemerge1, i8* null, i8* %%2, i8* %%1, i64* %%12) nounwind, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_96_count);
  crypto_aead_encrypt_c(( char *)llvm_cbe_tmp__16, (signed long long *)(&llvm_cbe_cclen), ( char *)llvm_cbe_tmp__9, llvm_cbe_storemerge8, ( char *)llvm_cbe_tmp__10, llvm_cbe_storemerge1, ( char *)(( char *)/*NULL*/0), ( char *)llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__7, (signed long long *)llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge8 = 0x%I64X",llvm_cbe_storemerge8);
printf("\nArgument storemerge1 = 0x%I64X",llvm_cbe_storemerge1);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load i64* %%cclen, align 8, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_103_count);
  llvm_cbe_tmp__29 = (unsigned long long )*(&llvm_cbe_cclen);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  call void @fprint_bstr(%%struct._iobuf* %%9, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str9, i64 0, i64 0), i8* %%11, i64 %%28), !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_104_count);
  fprint_bstr((l_struct_OC__iobuf *)llvm_cbe_tmp__15, ( char *)((&aesl_internal__OC_str9[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 6
#endif
])), ( char *)llvm_cbe_tmp__16, llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__29);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i32 @apatb_crypto_aead_encrypt_h_sw(i8* %%13, i64* %%hclen, i8* %%3, i64 %%storemerge8, i8* %%4, i64 %%storemerge1, i8* null, i8* %%2, i8* %%1, i64* %%14) nounwind, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_105_count);
  apatb_crypto_aead_encrypt_h_sw(( char *)llvm_cbe_tmp__18, (signed long long *)(&llvm_cbe_hclen), ( char *)llvm_cbe_tmp__9, llvm_cbe_storemerge8, ( char *)llvm_cbe_tmp__10, llvm_cbe_storemerge1, ( char *)(( char *)/*NULL*/0), ( char *)llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__7, (signed long long *)llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge8 = 0x%I64X",llvm_cbe_storemerge8);
printf("\nArgument storemerge1 = 0x%I64X",llvm_cbe_storemerge1);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%fputc = call i32 @fputc(i32 10, %%struct._iobuf* %%9), !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_fputc_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = load i64* %%cclen, align 8, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_112_count);
  llvm_cbe_tmp__31 = (unsigned long long )*(&llvm_cbe_cclen);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = call i32 @crypto_aead_decrypt(i8* %%15, i64* %%mlen2, i8* null, i8* %%11, i64 %%30, i8* %%4, i64 %%storemerge1, i8* %%2, i8* %%1, i64* %%14) nounwind, !dbg !14 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__32 = (unsigned int )crypto_aead_decrypt(( char *)llvm_cbe_tmp__20, (signed long long *)(&llvm_cbe_mlen2), ( char *)(( char *)/*NULL*/0), ( char *)llvm_cbe_tmp__16, llvm_cbe_tmp__31, ( char *)llvm_cbe_tmp__10, llvm_cbe_storemerge1, ( char *)llvm_cbe_tmp__8, ( char *)llvm_cbe_tmp__7, (signed long long *)llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__31);
printf("\nArgument storemerge1 = 0x%I64X",llvm_cbe_storemerge1);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%9, i8* getelementptr inbounds ([35 x i8]* @aesl_internal_.str11, i64 0, i64 0), i32 %%31) nounwind, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_118_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__15, ( char *)((&aesl_internal__OC_str11[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 35
#endif
])), llvm_cbe_tmp__32);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_119_count);
  llvm_cbe_tmp__34 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__34);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = getelementptr inbounds %%struct._iobuf* %%34, i64 1, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_120_count);
  llvm_cbe_tmp__35 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__34[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%35, i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str12, i64 0, i64 0), i32 %%25) nounwind, !dbg !10 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_121_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__35, ( char *)((&aesl_internal__OC_str12[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 29
#endif
])), llvm_cbe_tmp__26);
...
printf("\nReturn  = 0x%X",llvm_cbe_tmp__36);
  ...
  llvm_cbe_tmp__42__PHI_TEMPORARY = (unsigned int )4294967292u;   /* for PHI node */
  goto llvm_cbe__2e_critedge;

llvm_cbe__2e_critedge:
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = phi i32 [ -4, %%.loopexit.thread ], [ 0, %%.loopexit  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_135_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = call i32 @fclose(%%struct._iobuf* %%9) nounwind, !dbg !13 for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_136_count);
...
llvm_cbe_tmp__45:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ -1, %%16 ], [ %%44, %%.critedge  for 0x%I64xth hint within @generate_test_vectors  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
printf("\n  %%2 = trunc i64 %%storemerge1 to i8, !dbg !6 for 0x%I64xth hint within @init_buffer  --> \n", ++aesl_llvm_cbe_150_count);
  llvm_cbe_tmp__49 = (unsigned char )((unsigned char )llvm_cbe_storemerge1&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__49);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds i8* %%buffer, i64 %%storemerge1, !dbg !6 for 0x%I64xth hint within @init_buffer  --> \n", ++aesl_llvm_cbe_151_count);
  llvm_cbe_tmp__50 = ( char *)(&llvm_cbe_buffer[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%4 = add i64 %%storemerge1, 1, !dbg !7 for 0x%I64xth hint within @init_buffer  --> \n", ++aesl_llvm_cbe_153_count);
  llvm_cbe_tmp__51 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge1&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__51&18446744073709551615ull)));
  if (((llvm_cbe_tmp__51&18446744073709551615ULL) == (llvm_cbe_numbytes&18446744073709551615ULL))) {
    goto llvm_cbe__2e__crit_edge;
  } else {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__51;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  }
...
printf("\n  %%2 = getelementptr inbounds i8* %%data, i64 %%storemerge1, !dbg !6 for 0x%I64xth hint within @fprint_bstr  --> \n", ++aesl_llvm_cbe_177_count);
  llvm_cbe_tmp__52 = ( char *)(&llvm_cbe_data[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
printf("\nstoremerge1 = 0x%I64X",((signed long long )llvm_cbe_storemerge1));
}
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__56&18446744073709551615ull)));
  if (((llvm_cbe_tmp__56&18446744073709551615ULL) == (llvm_cbe_length&18446744073709551615ULL))) {
    goto llvm_cbe__2e__crit_edge;
  } else {
