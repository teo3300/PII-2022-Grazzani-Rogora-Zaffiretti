...
signed int crypto_aead_encrypt_c( char *llvm_cbe_c, signed long long *llvm_cbe_clen,  char *llvm_cbe_m, signed long long llvm_cbe_mlen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_nsec,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
signed int crypto_aead_encrypt( char *llvm_cbe_c, signed long long *llvm_cbe_clen,  char *llvm_cbe_m, signed long long llvm_cbe_mlen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_nsec,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
signed int crypto_aead_encrypt_h( char *llvm_cbe_c, signed long long *llvm_cbe_clen,  char *llvm_cbe_m, signed long long llvm_cbe_mlen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_nsec,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
signed int crypto_aead_encrypt_h_hw_stub( char *llvm_cbe_c, signed long long *llvm_cbe_clen,  char *llvm_cbe_m, signed long long llvm_cbe_mlen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_nsec,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
signed int apatb_crypto_aead_encrypt_h_sw( char *llvm_cbe_c, signed long long *llvm_cbe_clen,  char *llvm_cbe_m, signed long long llvm_cbe_mlen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_nsec,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
signed int apatb_crypto_aead_encrypt_h_ir( char *, signed long long *,  char *, signed long long ,  char *, signed long long ,  char *,  char *,  char *, signed long long *);
...
signed int crypto_aead_decrypt( char *llvm_cbe_m, signed long long *llvm_cbe_mlen,  char *llvm_cbe_nsec,  char *llvm_cbe_c, signed long long llvm_cbe_clen,  char *llvm_cbe_ad, signed long long llvm_cbe_adlen,  char *llvm_cbe_npub,  char *llvm_cbe_k, signed long long *llvm_cbe_st);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @crypto_aead_encrypt(i8* %%c, i64* %%clen, i8* %%m, i64 %%mlen, i8* %%ad, i64 %%adlen, i8* %%nsec, i8* %%npub, i8* %%k, i64* %%st), !dbg !10 for 0x%I64xth hint within @crypto_aead_encrypt_c  --> \n", ++aesl_llvm_cbe_74_count);
   /*tail*/ crypto_aead_encrypt(( char *)llvm_cbe_c, (signed long long *)llvm_cbe_clen, ( char *)llvm_cbe_m, llvm_cbe_mlen, ( char *)llvm_cbe_ad, llvm_cbe_adlen, ( char *)llvm_cbe_nsec, ( char *)llvm_cbe_npub, ( char *)llvm_cbe_k, (signed long long *)llvm_cbe_st);
if (AESL_DEBUG_TRACE) {
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = load i64* %%8, align 16, !dbg !12 for 0x%I64xth hint within @crypto_aead_encrypt  --> \n", ++aesl_llvm_cbe_163_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%23, i64* %%8, align 16, !dbg !12 for 0x%I64xth hint within @crypto_aead_encrypt  --> \n", ++aesl_llvm_cbe_165_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%34, i64* %%8, align 16, !dbg !13 for 0x%I64xth hint within @crypto_aead_encrypt  --> \n", ++aesl_llvm_cbe_189_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = load i64* %%8, align 16, !dbg !11 for 0x%I64xth hint within @crypto_aead_encrypt  --> \n", ++aesl_llvm_cbe_201_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%44, i64* %%8, align 16, !dbg !11 for 0x%I64xth hint within @crypto_aead_encrypt  --> \n", ++aesl_llvm_cbe_203_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @crypto_aead_encrypt(i8* %%c, i64* %%clen, i8* %%m, i64 %%mlen, i8* %%ad, i64 %%adlen, i8* %%nsec, i8* %%npub, i8* %%k, i64* %%st), !dbg !10 for 0x%I64xth hint within @crypto_aead_encrypt_h  --> \n", ++aesl_llvm_cbe_288_count);
   /*tail*/ crypto_aead_encrypt(( char *)llvm_cbe_c, (signed long long *)llvm_cbe_clen, ( char *)llvm_cbe_m, llvm_cbe_mlen, ( char *)llvm_cbe_ad, llvm_cbe_adlen, ( char *)llvm_cbe_nsec, ( char *)llvm_cbe_npub, ( char *)llvm_cbe_k, (signed long long *)llvm_cbe_st);
if (AESL_DEBUG_TRACE) {
printf("\nArgument mlen = 0x%I64X",llvm_cbe_mlen);
printf("\nArgument adlen = 0x%I64X",llvm_cbe_adlen);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @crypto_aead_encrypt_h_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @crypto_aead_encrypt_h(i8* %%c, i64* %%clen, i8* %%m, i64 %%mlen, i8* %%ad, i64 %%adlen, i8* %%nsec, i8* %%npub, i8* %%k, i64* %%st), !dbg !10 for 0x%I64xth hint within @crypto_aead_encrypt_h_hw_stub  --> \n", ++aesl_llvm_cbe_310_count);
   /*tail*/ crypto_aead_encrypt_h(( char *)llvm_cbe_c, (signed long long *)llvm_cbe_clen, ( char *)llvm_cbe_m, llvm_cbe_mlen, ( char *)llvm_cbe_ad, llvm_cbe_adlen, ( char *)llvm_cbe_nsec, ( char *)llvm_cbe_npub, ( char *)llvm_cbe_k, (signed long long *)llvm_cbe_st);
if (AESL_DEBUG_TRACE) {
printf("\nArgument mlen = 0x%I64X",llvm_cbe_mlen);
printf("\nArgument adlen = 0x%I64X",llvm_cbe_adlen);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__79);
  ...
  if (AESL_DEBUG_TRACE)
      printf("\nEND @crypto_aead_encrypt_h_hw_stub}\n");
  return 0u;
}
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_crypto_aead_encrypt_h_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @apatb_crypto_aead_encrypt_h_ir(i8* %%c, i64* %%clen, i8* %%m, i64 %%mlen, i8* %%ad, i64 %%adlen, i8* %%nsec, i8* %%npub, i8* %%k, i64* %%st) nounwind, !dbg !10 for 0x%I64xth hint within @apatb_crypto_aead_encrypt_h_sw  --> \n", ++aesl_llvm_cbe_334_count);
  llvm_cbe_tmp__80 = (unsigned int ) /*tail*/ apatb_crypto_aead_encrypt_h_ir(( char *)llvm_cbe_c, (signed long long *)llvm_cbe_clen, ( char *)llvm_cbe_m, llvm_cbe_mlen, ( char *)llvm_cbe_ad, llvm_cbe_adlen, ( char *)llvm_cbe_nsec, ( char *)llvm_cbe_npub, ( char *)llvm_cbe_k, (signed long long *)llvm_cbe_st);
if (AESL_DEBUG_TRACE) {
printf("\nArgument mlen = 0x%I64X",llvm_cbe_mlen);
printf("\nArgument adlen = 0x%I64X",llvm_cbe_adlen);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__80);
  ...
  if (AESL_DEBUG_TRACE)
      printf("\nEND @apatb_crypto_aead_encrypt_h_sw}\n");
...
printf("\n\{ BEGIN @aesl_internal_LOADBYTES\n");
  if ((((signed int )llvm_cbe_n) > ((signed int )0u))) {
    ...
    llvm_cbe_tmp__81__PHI_TEMPORARY = (unsigned long long )0ull;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
...
printf("\n  %%4 = getelementptr inbounds i8* %%bytes, i64 %%3, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_354_count);
  llvm_cbe_tmp__83 = ( char *)(&llvm_cbe_bytes[(((signed long long )llvm_cbe_tmp__82))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%5 = load volatile i8* %%4, align 1, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_355_count);
  llvm_cbe_tmp__84 = (unsigned char )*((unsigned char volatile*)llvm_cbe_tmp__83);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__84);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = zext i8 %%5 to i64, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_356_count);
  llvm_cbe_tmp__85 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__84&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__85);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = shl nsw i32 %%storemerge1, 3, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_357_count);
  llvm_cbe_tmp__86 = (unsigned int )llvm_cbe_storemerge1 << 3u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__86);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = sub nsw i32 56, %%7, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_358_count);
  llvm_cbe_tmp__87 = (unsigned int )((unsigned int )(56u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__86&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%9 = zext i32 %%8 to i64, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_359_count);
  llvm_cbe_tmp__88 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__87&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__88);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = shl i64 %%6, %%9, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_360_count);
  llvm_cbe_tmp__89 = (unsigned long long )llvm_cbe_tmp__85 << llvm_cbe_tmp__88;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__89);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = or i64 %%10, %%2, !dbg !10 for 0x%I64xth hint within @aesl_internal_LOADBYTES  --> \n", ++aesl_llvm_cbe_361_count);
  llvm_cbe_tmp__90 = (unsigned long long )llvm_cbe_tmp__89 | llvm_cbe_tmp__81;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__90);
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__91&4294967295ull)));
  if (((llvm_cbe_tmp__91&4294967295U) == (llvm_cbe_n&4294967295U))) {
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__90;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  } else {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__91;   /* for PHI node */
    llvm_cbe_tmp__81__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__90;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call fastcc void @aesl_internal_ROUND(i64* %%s, i8 zeroext -46), !dbg !10 for 0x%I64xth hint within @aesl_internal_P12  --> \n", ++aesl_llvm_cbe_388_count);
   /*tail*/ aesl_internal_ROUND((signed long long *)llvm_cbe_s, ((unsigned char )-46));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )-46));
}
if (AESL_DEBUG_TRACE)
printf("\n  tail call fastcc void @aesl_internal_ROUND(i64* %%s, i8 zeroext -61), !dbg !10 for 0x%I64xth hint within @aesl_internal_P12  --> \n", ++aesl_llvm_cbe_389_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call fastcc void @aesl_internal_ROUND(i64* %%s, i8 zeroext 120), !dbg !10 for 0x%I64xth hint within @aesl_internal_P6  --> \n", ++aesl_llvm_cbe_408_count);
   /*tail*/ aesl_internal_ROUND((signed long long *)llvm_cbe_s, ((unsigned char )120));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )120));
}
if (AESL_DEBUG_TRACE)
printf("\n  tail call fastcc void @aesl_internal_ROUND(i64* %%s, i8 zeroext 105), !dbg !10 for 0x%I64xth hint within @aesl_internal_P6  --> \n", ++aesl_llvm_cbe_409_count);
   /*tail*/ aesl_internal_ROUND((signed long long *)llvm_cbe_s, ((unsigned char )105));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )105));
}
...
printf("\n  %%2 = shl nsw i32 %%storemerge1, 3, !dbg !10 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_426_count);
  llvm_cbe_tmp__92 = (unsigned int )llvm_cbe_storemerge1 << 3u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__92);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sub nsw i32 56, %%2, !dbg !10 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_427_count);
  llvm_cbe_tmp__93 = (unsigned int )((unsigned int )(56u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__92&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%5 = lshr i64 %%x, %%4, !dbg !10 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_429_count);
  llvm_cbe_tmp__95 = (unsigned long long )((unsigned long long )(((unsigned long long )(llvm_cbe_x&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__94&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%8 = getelementptr inbounds i8* %%bytes, i64 %%7, !dbg !10 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_432_count);
  llvm_cbe_tmp__98 = ( char *)(&llvm_cbe_bytes[(((signed long long )llvm_cbe_tmp__97))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  store volatile i8 %%6, i8* %%8, align 1, !dbg !10 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_433_count);
  *((unsigned char volatile*)llvm_cbe_tmp__98) = llvm_cbe_tmp__96;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__96);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge1, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_STOREBYTES  --> \n", ++aesl_llvm_cbe_434_count);
  llvm_cbe_tmp__99 = (unsigned int )((unsigned int )(llvm_cbe_storemerge1&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__99&4294967295ull)));
  if (((llvm_cbe_tmp__99&4294967295U) == (llvm_cbe_n&4294967295U))) {
    goto llvm_cbe__2e__crit_edge;
  } else {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__99;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  }
...
printf("\n  %%3 = add i64 %%clen, -16, !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_486_count);
  llvm_cbe_tmp__100 = (unsigned long long )((unsigned long long )(llvm_cbe_clen&18446744073709551615ull)) + ((unsigned long long )(18446744073709551600ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__100&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%3, i64* %%mlen, align 8, !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_487_count);
  *llvm_cbe_mlen = llvm_cbe_tmp__100;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__100);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%k, i32 8), !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_488_count);
  llvm_cbe_tmp__101 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_k, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
...
printf("\n  %%5 = getelementptr inbounds i8* %%k, i64 8, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_494_count);
  llvm_cbe_tmp__102 = ( char *)(&llvm_cbe_k[(((signed long long )8ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%5, i32 8), !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_495_count);
  llvm_cbe_tmp__103 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_tmp__102, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
...
printf("\n  %%7 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%npub, i32 8), !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_501_count);
  llvm_cbe_tmp__104 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_npub, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
...
printf("\n  %%8 = getelementptr inbounds i8* %%npub, i64 8, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_504_count);
  llvm_cbe_tmp__105 = ( char *)(&llvm_cbe_npub[(((signed long long )8ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%8, i32 8), !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_505_count);
  llvm_cbe_tmp__106 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_tmp__105, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__106);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds [5 x i64]* %%s, i64 0, i64 0, !dbg !17 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_509_count);
  llvm_cbe_tmp__107 = (signed long long *)(&llvm_cbe_s[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 5
#endif
]);
...
printf("\n  store i64 -9205344418435956736, i64* %%10, align 16, !dbg !17 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_510_count);
  *llvm_cbe_tmp__107 = 9241399655273594880ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 9241399655273594880ull);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [5 x i64]* %%s, i64 0, i64 1, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_511_count);
  llvm_cbe_tmp__108 = (signed long long *)(&llvm_cbe_s[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 5
#endif
]);
...
printf("\n  store i64 %%4, i64* %%11, align 8, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_512_count);
  *llvm_cbe_tmp__108 = llvm_cbe_tmp__101;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__101);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds [5 x i64]* %%s, i64 0, i64 2, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_513_count);
  llvm_cbe_tmp__109 = (signed long long *)(&llvm_cbe_s[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 5
#endif
]);
...
printf("\n  %%13 = getelementptr inbounds [5 x i64]* %%s, i64 0, i64 3, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_515_count);
  llvm_cbe_tmp__110 = (signed long long *)(&llvm_cbe_s[(((signed long long )3ull))
#ifdef AESL_BC_SIM
 % 5
#endif
]);
...
printf("\n  store i64 %%7, i64* %%13, align 8, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_516_count);
  *llvm_cbe_tmp__110 = llvm_cbe_tmp__104;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__104);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds [5 x i64]* %%s, i64 0, i64 4, !dbg !17 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_517_count);
  llvm_cbe_tmp__111 = (signed long long *)(&llvm_cbe_s[(((signed long long )4ull))
#ifdef AESL_BC_SIM
 % 5
#endif
]);
...
printf("\n  call fastcc void @aesl_internal_P12(i64* %%10), !dbg !17 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_519_count);
  aesl_internal_P12((signed long long *)llvm_cbe_tmp__107);
if (AESL_DEBUG_TRACE) {
}
...
printf("\n  %%15 = load i64* %%13, align 8, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_520_count);
  llvm_cbe_tmp__112 = (unsigned long long )*llvm_cbe_tmp__110;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__112);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = xor i64 %%15, %%4, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_521_count);
  llvm_cbe_tmp__113 = (unsigned long long )llvm_cbe_tmp__112 ^ llvm_cbe_tmp__101;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__113);
...
printf("\n  store i64 %%16, i64* %%13, align 8, !dbg !15 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_522_count);
  *llvm_cbe_tmp__110 = llvm_cbe_tmp__113;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__113);
...
printf("\n  %%17 = load i64* %%14, align 16, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_523_count);
  llvm_cbe_tmp__114 = (unsigned long long )*llvm_cbe_tmp__111;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__114);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = xor i64 %%17, %%6, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_524_count);
  llvm_cbe_tmp__115 = (unsigned long long )llvm_cbe_tmp__114 ^ llvm_cbe_tmp__103;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__115);
...
llvm_cbe__2e_preheader:
  if ((((unsigned long long )llvm_cbe_adlen&18446744073709551615ULL) > ((unsigned long long )7ull&18446744073709551615ULL))) {
    ...
    llvm_cbe_tmp__116__PHI_TEMPORARY = (unsigned long long )llvm_cbe_adlen;   /* for PHI node */
...
printf("\n  %%22 = getelementptr i8* %%ad, i64 %%.rec2 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_531_count);
  llvm_cbe_tmp__117 = ( char *)(&llvm_cbe_ad[(((signed long long )llvm_cbe__2e_rec23))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%23 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%22, i32 8), !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_532_count);
  llvm_cbe_tmp__118 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_tmp__117, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
...
printf("\n  %%24 = load i64* %%10, align 16, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_533_count);
  llvm_cbe_tmp__119 = (unsigned long long )*llvm_cbe_tmp__107;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__119);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%26 = getelementptr inbounds i8* %%ad, i64 %%.rec24, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_537_count);
  llvm_cbe_tmp__121 = ( char *)(&llvm_cbe_ad[(((signed long long )llvm_cbe__2e_rec24))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%27 = add i64 %%21, -8, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_542_count);
  llvm_cbe_tmp__122 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__116&18446744073709551615ull)) + ((unsigned long long )(18446744073709551608ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__122&18446744073709551615ull)));
  if ((((unsigned long long )llvm_cbe_tmp__122&18446744073709551615ULL) > ((unsigned long long )7ull&18446744073709551615ULL))) {
    llvm_cbe__2e_rec23__PHI_TEMPORARY = (unsigned long long )llvm_cbe__2e_rec24;   /* for PHI node */
    llvm_cbe_tmp__116__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__122;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph11;
  } else {
    llvm_cbe__2e_lcssa10__PHI_TEMPORARY = ( char *)llvm_cbe_tmp__121;   /* for PHI node */
    llvm_cbe__2e_lcssa9__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__122;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge12;
  }
...
printf("\n  %%29 = trunc i64 %%.lcssa9 to i32, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_551_count);
  llvm_cbe_tmp__123 = (unsigned int )((unsigned int )llvm_cbe__2e_lcssa9&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__123);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%.lcssa10, i32 %%29), !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_552_count);
  llvm_cbe_tmp__124 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe__2e_lcssa10, llvm_cbe_tmp__123);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__123);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__124);
}
...
printf("\n  %%31 = load i64* %%10, align 16, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_553_count);
  llvm_cbe_tmp__125 = (unsigned long long )*llvm_cbe_tmp__107;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__125);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = shl i64 %%.lcssa9, 3, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_554_count);
  llvm_cbe_tmp__126 = (unsigned long long )llvm_cbe__2e_lcssa9 << 3ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__126);
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = sub i64 56, %%32, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_555_count);
  llvm_cbe_tmp__127 = (unsigned long long )((unsigned long long )(56ull&18446744073709551615ull)) - ((unsigned long long )(llvm_cbe_tmp__126&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%34 = shl i64 128, %%33, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_556_count);
  llvm_cbe_tmp__128 = (unsigned long long )128ull << llvm_cbe_tmp__127;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__128);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = xor i64 %%30, %%34, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_557_count);
  llvm_cbe_tmp__129 = (unsigned long long )llvm_cbe_tmp__124 ^ llvm_cbe_tmp__128;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__129);
if (AESL_DEBUG_TRACE)
...
printf("\n  store i64 %%36, i64* %%10, align 16, !dbg !14 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_559_count);
  *llvm_cbe_tmp__107 = llvm_cbe_tmp__130;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__130);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%38 = load i64* %%14, align 16, !dbg !18 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_562_count);
  llvm_cbe_tmp__131 = (unsigned long long )*llvm_cbe_tmp__111;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__131);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = xor i64 %%38, 1, !dbg !18 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_563_count);
  llvm_cbe_tmp__132 = (unsigned long long )llvm_cbe_tmp__131 ^ 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__132);
...
printf("\n  store i64 %%39, i64* %%14, align 16, !dbg !18 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_564_count);
  *llvm_cbe_tmp__111 = llvm_cbe_tmp__132;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__132);
  if ((((unsigned long long )llvm_cbe_tmp__100&18446744073709551615ULL) > ((unsigned long long )7ull&18446744073709551615ULL))) {
    llvm_cbe_storemerge6__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__100;   /* for PHI node */
    llvm_cbe__2e_rec__PHI_TEMPORARY = (unsigned long long )0ull;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
    llvm_cbe_storemerge_2e_lcssa__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__100;   /* for PHI node */
...
printf("\n  %%41 = getelementptr i8* %%c, i64 %%.re for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_578_count);
  llvm_cbe_tmp__133 = ( char *)(&llvm_cbe_c[(((signed long long )llvm_cbe__2e_rec))]);
if (AESL_DEBUG_TRACE) {
printf("\n.rec = 0x%I64X",((signed long long )llvm_cbe__2e_rec));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = getelementptr i8* %%m, i64 %%.re for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_579_count);
  llvm_cbe_tmp__134 = ( char *)(&llvm_cbe_m[(((signed long long )llvm_cbe__2e_rec))]);
if (AESL_DEBUG_TRACE) {
printf("\n.rec = 0x%I64X",((signed long long )llvm_cbe__2e_rec));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%41, i32 8), !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_580_count);
  llvm_cbe_tmp__135 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe_tmp__133, 8u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",8u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__135);
}
...
printf("\n  %%44 = load i64* %%10, align 16, !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_584_count);
  llvm_cbe_tmp__136 = (unsigned long long )*llvm_cbe_tmp__107;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__136);
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = xor i64 %%44, %%43, !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_585_count);
  llvm_cbe_tmp__137 = (unsigned long long )llvm_cbe_tmp__136 ^ llvm_cbe_tmp__135;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__137);
if (AESL_DEBUG_TRACE)
printf("\n  call fastcc void @aesl_internal_STOREBYTES(i8* %%42, i64 %%45, i32 8), !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_586_count);
  aesl_internal_STOREBYTES(( char *)llvm_cbe_tmp__134, llvm_cbe_tmp__137, 8u);
if (AESL_DEBUG_TRACE) {
...
printf("\n  store i64 %%43, i64* %%10, align 16, !dbg !18 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_587_count);
  *llvm_cbe_tmp__107 = llvm_cbe_tmp__135;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__135);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%46 = getelementptr inbounds i8* %%m, i64 %%.rec18, !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_589_count);
  llvm_cbe_tmp__138 = ( char *)(&llvm_cbe_m[(((signed long long )llvm_cbe__2e_rec18))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%47 = getelementptr inbounds i8* %%c, i64 %%.rec18, !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_594_count);
  llvm_cbe_tmp__139 = ( char *)(&llvm_cbe_c[(((signed long long )llvm_cbe__2e_rec18))]);
if (AESL_DEBUG_TRACE) {
printf("\n.rec18 = 0x%I64X",((signed long long )llvm_cbe__2e_rec18));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = add i64 %%storemerge6, -8, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_601_count);
  llvm_cbe_tmp__140 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge6&18446744073709551615ull)) + ((unsigned long long )(18446744073709551608ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__140&18446744073709551615ull)));
  if ((((unsigned long long )llvm_cbe_tmp__140&18446744073709551615ULL) > ((unsigned long long )7ull&18446744073709551615ULL))) {
    llvm_cbe_storemerge6__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__140;   /* for PHI node */
    llvm_cbe__2e_rec__PHI_TEMPORARY = (unsigned long long )llvm_cbe__2e_rec18;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
    llvm_cbe_storemerge_2e_lcssa__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__140;   /* for PHI node */
    llvm_cbe__2e_lcssa5__PHI_TEMPORARY = ( char *)llvm_cbe_tmp__138;   /* for PHI node */
    llvm_cbe__2e_lcssa4__PHI_TEMPORARY = ( char *)llvm_cbe_tmp__139;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  }
...
printf("\n  %%50 = trunc i64 %%storemerge.lcssa to i32, !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_615_count);
  llvm_cbe_tmp__141 = (unsigned int )((unsigned int )llvm_cbe_storemerge_2e_lcssa&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__141);
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = call fastcc i64 @aesl_internal_LOADBYTES(i8* %%.lcssa4, i32 %%50), !dbg !11 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_616_count);
  llvm_cbe_tmp__142 = (unsigned long long )aesl_internal_LOADBYTES(( char *)llvm_cbe__2e_lcssa4, llvm_cbe_tmp__141);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__141);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__142);
}
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = load i64* %%10, align 16, !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_620_count);
  llvm_cbe_tmp__143 = (unsigned long long )*llvm_cbe_tmp__107;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__143);
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = xor i64 %%52, %%51, !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_621_count);
  llvm_cbe_tmp__144 = (unsigned long long )llvm_cbe_tmp__143 ^ llvm_cbe_tmp__142;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__144);
if (AESL_DEBUG_TRACE)
printf("\n  call fastcc void @aesl_internal_STOREBYTES(i8* %%.lcssa5, i64 %%53, i32 %%50), !dbg !10 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_622_count);
  aesl_internal_STOREBYTES(( char *)llvm_cbe__2e_lcssa5, llvm_cbe_tmp__144, llvm_cbe_tmp__141);
if (AESL_DEBUG_TRACE) {
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = load i64* %%10, align 16, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_623_count);
  llvm_cbe_tmp__145 = (unsigned long long )*llvm_cbe_tmp__107;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__145);
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = call fastcc i64 @aesl_internal_CLEARBYTES(i64 %%54, i32 %%50), !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_624_count);
  llvm_cbe_tmp__146 = (unsigned long long )aesl_internal_CLEARBYTES(llvm_cbe_tmp__145, llvm_cbe_tmp__141);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__145);
printf("\nArgument  = 0x%X",llvm_cbe_tmp__141);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__146);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = or i64 %%55, %%51, !dbg !18 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_625_count);
  llvm_cbe_tmp__147 = (unsigned long long )llvm_cbe_tmp__146 | llvm_cbe_tmp__142;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__147);
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = shl i64 %%storemerge.lcssa, 3, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_626_count);
  llvm_cbe_tmp__148 = (unsigned long long )llvm_cbe_storemerge_2e_lcssa << 3ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__148);
if (AESL_DEBUG_TRACE)
printf("\n  %%58 = sub i64 56, %%57, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_627_count);
  llvm_cbe_tmp__149 = (unsigned long long )((unsigned long long )(56ull&18446744073709551615ull)) - ((unsigned long long )(llvm_cbe_tmp__148&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%59 = shl i64 128, %%58, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_628_count);
  llvm_cbe_tmp__150 = (unsigned long long )128ull << llvm_cbe_tmp__149;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__150);
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = xor i64 %%56, %%59, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_629_count);
  llvm_cbe_tmp__151 = (unsigned long long )llvm_cbe_tmp__147 ^ llvm_cbe_tmp__150;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__151);
...
printf("\n  store i64 %%60, i64* %%10, align 16, !dbg !13 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_630_count);
  *llvm_cbe_tmp__107 = llvm_cbe_tmp__151;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__151);
...
printf("\n  %%61 = load i64* %%11, align 8, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_631_count);
  llvm_cbe_tmp__152 = (unsigned long long )*llvm_cbe_tmp__108;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__152);
if (AESL_DEBUG_TRACE)
printf("\n  %%62 = xor i64 %%61, %%4, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_632_count);
  llvm_cbe_tmp__153 = (unsigned long long )llvm_cbe_tmp__152 ^ llvm_cbe_tmp__101;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__153);
...
printf("\n  store i64 %%62, i64* %%11, align 8, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_633_count);
  *llvm_cbe_tmp__108 = llvm_cbe_tmp__153;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__153);
...
printf("\n  %%63 = load i64* %%12, align 16, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_634_count);
  llvm_cbe_tmp__154 = (unsigned long long )*llvm_cbe_tmp__109;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__154);
if (AESL_DEBUG_TRACE)
printf("\n  %%64 = xor i64 %%63, %%6, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_635_count);
  llvm_cbe_tmp__155 = (unsigned long long )llvm_cbe_tmp__154 ^ llvm_cbe_tmp__103;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__155);
...
printf("\n  store i64 %%64, i64* %%12, align 16, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_636_count);
  *llvm_cbe_tmp__109 = llvm_cbe_tmp__155;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__155);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%65 = load i64* %%13, align 8, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_638_count);
  llvm_cbe_tmp__156 = (unsigned long long )*llvm_cbe_tmp__110;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__156);
if (AESL_DEBUG_TRACE)
printf("\n  %%66 = xor i64 %%65, %%4, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_639_count);
  llvm_cbe_tmp__157 = (unsigned long long )llvm_cbe_tmp__156 ^ llvm_cbe_tmp__101;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__157);
...
printf("\n  store i64 %%66, i64* %%13, align 8, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_640_count);
  *llvm_cbe_tmp__110 = llvm_cbe_tmp__157;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__157);
...
printf("\n  %%67 = load i64* %%14, align 16, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_641_count);
  llvm_cbe_tmp__158 = (unsigned long long )*llvm_cbe_tmp__111;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__158);
if (AESL_DEBUG_TRACE)
printf("\n  %%68 = xor i64 %%67, %%6, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_642_count);
  llvm_cbe_tmp__159 = (unsigned long long )llvm_cbe_tmp__158 ^ llvm_cbe_tmp__103;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__159);
...
printf("\n  store i64 %%68, i64* %%14, align 16, !dbg !16 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_643_count);
  *llvm_cbe_tmp__111 = llvm_cbe_tmp__159;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__159);
if (AESL_DEBUG_TRACE)
printf("\n  %%69 = getelementptr inbounds [16 x i8]* %%t, i64 0, i64 0, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_645_count);
  llvm_cbe_tmp__160 = ( char *)(&llvm_cbe_t[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  call fastcc void @aesl_internal_STOREBYTES(i8* %%69, i64 %%66, i32 8), !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_646_count);
  aesl_internal_STOREBYTES(( char *)llvm_cbe_tmp__160, llvm_cbe_tmp__157, 8u);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%70 = getelementptr inbounds [16 x i8]* %%t, i64 0, i64 8, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_647_count);
  llvm_cbe_tmp__161 = ( char *)(&llvm_cbe_t[(((signed long long )8ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%71 = load i64* %%14, align 16, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_648_count);
  llvm_cbe_tmp__162 = (unsigned long long )*llvm_cbe_tmp__111;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__162);
if (AESL_DEBUG_TRACE)
printf("\n  call fastcc void @aesl_internal_STOREBYTES(i8* %%70, i64 %%71, i32 8), !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_649_count);
  aesl_internal_STOREBYTES(( char *)llvm_cbe_tmp__161, llvm_cbe_tmp__162, 8u);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%74 = sext i32 %%storemerge13 to i64, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_661_count);
  llvm_cbe_tmp__164 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge13);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__164);
if (AESL_DEBUG_TRACE)
printf("\n  %%.sum = add i64 %%74, %%storemerge.lcssa, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe__2e_sum_count);
  llvm_cbe__2e_sum = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__164&18446744073709551615ull)) + ((unsigned long long )(llvm_cbe_storemerge_2e_lcssa&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n.sum = 0x%I64X\n", ((unsigned long long )(llvm_cbe__2e_sum&18446744073709551615ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%75 = getelementptr inbounds i8* %%.lcssa4, i64 %%.sum, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_662_count);
  llvm_cbe_tmp__165 = ( char *)(&llvm_cbe__2e_lcssa4[(((signed long long )llvm_cbe__2e_sum))]);
if (AESL_DEBUG_TRACE) {
printf("\n.sum = 0x%I64X",((signed long long )llvm_cbe__2e_sum));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%76 = load i8* %%75, align 1, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_663_count);
...
printf("\n  %%77 = getelementptr inbounds [16 x i8]* %%t, i64 0, i64 %%74, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_664_count);
  llvm_cbe_tmp__167 = ( char *)(&llvm_cbe_t[(((signed long long )llvm_cbe_tmp__164))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__164) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 't' bound?\n", __FILE__, __LINE__);
...
printf("\n  %%79 = xor i8 %%78, %%76, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_666_count);
  llvm_cbe_tmp__169 = (unsigned char )((unsigned char )(llvm_cbe_tmp__168 ^ llvm_cbe_tmp__166));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__169);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%81 = or i32 %%80, %%73, !dbg !12 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_668_count);
  llvm_cbe_tmp__171 = (unsigned int )llvm_cbe_tmp__170 | llvm_cbe_tmp__163;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__171);
if (AESL_DEBUG_TRACE)
printf("\n  %%82 = add nsw i32 %%storemerge13, 1, !dbg !20 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_673_count);
  llvm_cbe_tmp__172 = (unsigned int )((unsigned int )(llvm_cbe_storemerge13&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__172&4294967295ull)));
  if (((llvm_cbe_tmp__172&4294967295U) == (16u&4294967295U))) {
    goto llvm_cbe_tmp__181;
  } else {
    llvm_cbe_storemerge13__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__172;   /* for PHI node */
...
printf("\n  %%84 = add nsw i32 %%81, 511, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_680_count);
  llvm_cbe_tmp__173 = (unsigned int )((unsigned int )(llvm_cbe_tmp__171&4294967295ull)) + ((unsigned int )(511u&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%85 = lshr i32 %%84, 8, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_681_count);
  llvm_cbe_tmp__174 = (unsigned int )((unsigned int )(((unsigned int )(llvm_cbe_tmp__173&4294967295ull)) >> ((unsigned int )(8u&4294967295ull))));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%86 = and i32 %%85, 1, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_682_count);
  llvm_cbe_tmp__175 = (unsigned int )llvm_cbe_tmp__174 & 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__175);
if (AESL_DEBUG_TRACE)
printf("\n  %%87 = add nsw i32 %%86, -1, !dbg !19 for 0x%I64xth hint within @crypto_aead_decrypt  --> \n", ++aesl_llvm_cbe_683_count);
  llvm_cbe_tmp__176 = (unsigned int )((unsigned int )(llvm_cbe_tmp__175&4294967295ull)) + ((unsigned int )(4294967295u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__176&4294967295ull)));
  llvm_cbe_storemerge2__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__176;   /* for PHI node */
  goto llvm_cbe_tmp__177;
...
printf("\n\{ BEGIN @aesl_internal_CLEARBYTES\n");
  if ((((signed int )llvm_cbe_n) > ((signed int )0u))) {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
    llvm_cbe_tmp__182__PHI_TEMPORARY = (unsigned long long )llvm_cbe_x;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
...
printf("\n  %%3 = shl nsw i32 %%storemerge1, 3, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_702_count);
  llvm_cbe_tmp__183 = (unsigned int )llvm_cbe_storemerge1 << 3u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__183);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sub nsw i32 56, %%3, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_703_count);
  llvm_cbe_tmp__184 = (unsigned int )((unsigned int )(56u&4294967295ull)) - ((unsigned int )(llvm_cbe_tmp__183&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%5 = zext i32 %%4 to i64, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_704_count);
  llvm_cbe_tmp__185 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_tmp__184&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__185);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = shl i64 255, %%5, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_705_count);
  llvm_cbe_tmp__186 = (unsigned long long )255ull << llvm_cbe_tmp__185;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__186);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = xor i64 %%6, -1, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_706_count);
  llvm_cbe_tmp__187 = (unsigned long long )llvm_cbe_tmp__186 ^ 18446744073709551615ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__187);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = and i64 %%2, %%7, !dbg !10 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_707_count);
  llvm_cbe_tmp__188 = (unsigned long long )llvm_cbe_tmp__182 & llvm_cbe_tmp__187;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__188);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge1, 1, !dbg !11 for 0x%I64xth hint within @aesl_internal_CLEARBYTES  --> \n", ++aesl_llvm_cbe_711_count);
  llvm_cbe_tmp__189 = (unsigned int )((unsigned int )(llvm_cbe_storemerge1&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__189&4294967295ull)));
  if (((llvm_cbe_tmp__189&4294967295U) == (llvm_cbe_n&4294967295U))) {
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__188;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  } else {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__189;   /* for PHI node */
    llvm_cbe_tmp__182__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__188;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  }
...
printf("\n  %%1 = zext i8 %%C to i64, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_749_count);
  llvm_cbe_tmp__190 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_C&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__190);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds i64* %%s, i64 2, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_750_count);
  llvm_cbe_tmp__191 = (signed long long *)(&llvm_cbe_s[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%4 = xor i64 %%3, %%1, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_752_count);
  llvm_cbe_tmp__193 = (unsigned long long )llvm_cbe_tmp__192 ^ llvm_cbe_tmp__190;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__193);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds i64* %%s, i64 4, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_753_count);
  llvm_cbe_tmp__194 = (signed long long *)(&llvm_cbe_s[(((signed long long )4ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%7 = load i64* %%s, align 8, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_755_count);
  llvm_cbe_tmp__196 = (unsigned long long )*llvm_cbe_s;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__196);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = xor i64 %%7, %%6, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_756_count);
  llvm_cbe_tmp__197 = (unsigned long long )llvm_cbe_tmp__196 ^ llvm_cbe_tmp__195;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__197);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds i64* %%s, i64 3, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_757_count);
  llvm_cbe_tmp__198 = (signed long long *)(&llvm_cbe_s[(((signed long long )3ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i64* %%9, align 8, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_758_count);
  llvm_cbe_tmp__199 = (unsigned long long )*llvm_cbe_tmp__198;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__199);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = xor i64 %%6, %%10, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_759_count);
  llvm_cbe_tmp__200 = (unsigned long long )llvm_cbe_tmp__195 ^ llvm_cbe_tmp__199;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__200);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds i64* %%s, i64 1, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_760_count);
  llvm_cbe_tmp__201 = (signed long long *)(&llvm_cbe_s[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load i64* %%12, align 8, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_761_count);
  llvm_cbe_tmp__202 = (unsigned long long )*llvm_cbe_tmp__201;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__202);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = xor i64 %%4, %%13, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_762_count);
  llvm_cbe_tmp__203 = (unsigned long long )llvm_cbe_tmp__193 ^ llvm_cbe_tmp__202;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__203);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = xor i64 %%13, -1, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_763_count);
  llvm_cbe_tmp__204 = (unsigned long long )llvm_cbe_tmp__202 ^ 18446744073709551615ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__204);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%34 = call fastcc i64 @aesl_internal_ROR(i64 %%31, i32 19), !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_782_count);
  llvm_cbe_tmp__223 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__220, 19u);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%35 = call fastcc i64 @aesl_internal_ROR(i64 %%31, i32 28), !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_783_count);
  llvm_cbe_tmp__224 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__220, 28u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__220);
printf("\nArgument  = 0x%X",28u);
...
printf("\n  %%36 = xor i64 %%34, %%31, !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_784_count);
  llvm_cbe_tmp__225 = (unsigned long long )llvm_cbe_tmp__223 ^ llvm_cbe_tmp__220;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__225);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%38 = call fastcc i64 @aesl_internal_ROR(i64 %%30, i32 61), !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_787_count);
  llvm_cbe_tmp__227 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__219, 61u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__219);
printf("\nArgument  = 0x%X",61u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__227);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = call fastcc i64 @aesl_internal_ROR(i64 %%30, i32 39), !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_788_count);
  llvm_cbe_tmp__228 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__219, 39u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__219);
printf("\nArgument  = 0x%X",39u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__228);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = xor i64 %%38, %%30, !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_789_count);
  llvm_cbe_tmp__229 = (unsigned long long )llvm_cbe_tmp__227 ^ llvm_cbe_tmp__219;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__229);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = xor i64 %%40, %%39, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_790_count);
  llvm_cbe_tmp__230 = (unsigned long long )llvm_cbe_tmp__229 ^ llvm_cbe_tmp__228;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__230);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%41, i64* %%12, align 8, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_791_count);
  *llvm_cbe_tmp__201 = llvm_cbe_tmp__230;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__230);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = call fastcc i64 @aesl_internal_ROR(i64 %%33, i32 1), !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_792_count);
  llvm_cbe_tmp__231 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__222, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__222);
printf("\nArgument  = 0x%X",1u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__231);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call fastcc i64 @aesl_internal_ROR(i64 %%33, i32 6), !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_793_count);
  llvm_cbe_tmp__232 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__222, 6u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__222);
printf("\nArgument  = 0x%X",6u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__232);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = xor i64 %%42, %%33, !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_794_count);
  llvm_cbe_tmp__233 = (unsigned long long )llvm_cbe_tmp__231 ^ llvm_cbe_tmp__222;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__233);
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = xor i64 %%44, %%43, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_795_count);
  llvm_cbe_tmp__234 = (unsigned long long )llvm_cbe_tmp__233 ^ llvm_cbe_tmp__232;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__234);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%45, i64* %%2, align 8, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_796_count);
  *llvm_cbe_tmp__191 = llvm_cbe_tmp__234;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__234);
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = call fastcc i64 @aesl_internal_ROR(i64 %%32, i32 10), !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_797_count);
  llvm_cbe_tmp__235 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__221, 10u);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = call fastcc i64 @aesl_internal_ROR(i64 %%32, i32 17), !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_798_count);
  llvm_cbe_tmp__236 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__221, 17u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__221);
printf("\nArgument  = 0x%X",17u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__236);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = xor i64 %%46, %%32, !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_799_count);
  llvm_cbe_tmp__237 = (unsigned long long )llvm_cbe_tmp__235 ^ llvm_cbe_tmp__221;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__237);
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = xor i64 %%48, %%47, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_800_count);
  llvm_cbe_tmp__238 = (unsigned long long )llvm_cbe_tmp__237 ^ llvm_cbe_tmp__236;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__238);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%49, i64* %%9, align 8, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_801_count);
  *llvm_cbe_tmp__198 = llvm_cbe_tmp__238;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__238);
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = call fastcc i64 @aesl_internal_ROR(i64 %%29, i32 7), !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_802_count);
  llvm_cbe_tmp__239 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__218, 7u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__218);
printf("\nArgument  = 0x%X",7u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__239);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = call fastcc i64 @aesl_internal_ROR(i64 %%29, i32 41), !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_803_count);
  llvm_cbe_tmp__240 = (unsigned long long )aesl_internal_ROR(llvm_cbe_tmp__218, 41u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__218);
printf("\nArgument  = 0x%X",41u);
printf("\nReturn  = 0x%I64X",llvm_cbe_tmp__240);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = xor i64 %%50, %%29, !dbg !13 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_804_count);
  llvm_cbe_tmp__241 = (unsigned long long )llvm_cbe_tmp__239 ^ llvm_cbe_tmp__218;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__241);
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = xor i64 %%52, %%51, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_805_count);
  llvm_cbe_tmp__242 = (unsigned long long )llvm_cbe_tmp__241 ^ llvm_cbe_tmp__240;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__242);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 %%53, i64* %%5, align 8, !dbg !11 for 0x%I64xth hint within @aesl_internal_ROUND  --> \n", ++aesl_llvm_cbe_806_count);
  *llvm_cbe_tmp__194 = llvm_cbe_tmp__242;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__242);
  if (AESL_DEBUG_TRACE)
...
printf("\n  %%1 = zext i32 %%n to i64, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROR  --> \n", ++aesl_llvm_cbe_812_count);
  llvm_cbe_tmp__243 = (unsigned long long )((unsigned long long )(unsigned int )llvm_cbe_n&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__243);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = lshr i64 %%x, %%1, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROR  --> \n", ++aesl_llvm_cbe_813_count);
  llvm_cbe_tmp__244 = (unsigned long long )((unsigned long long )(((unsigned long long )(llvm_cbe_x&18446744073709551615ull)) >> ((unsigned long long )(llvm_cbe_tmp__243&18446744073709551615ull))));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%3 = sub nsw i32 0, %%n, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROR  --> \n", ++aesl_llvm_cbe_816_count);
  llvm_cbe_tmp__245 = (unsigned int )-(llvm_cbe_n);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%4 = and i32 %%3, 63, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROR  --> \n", ++aesl_llvm_cbe_817_count);
  llvm_cbe_tmp__246 = (unsigned int )llvm_cbe_tmp__245 & 63u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__246);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%6 = shl i64 %%x, %%5, !dbg !10 for 0x%I64xth hint within @aesl_internal_ROR  --> \n", ++aesl_llvm_cbe_819_count);
  llvm_cbe_tmp__248 = (unsigned long long )llvm_cbe_x << llvm_cbe_tmp__247;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__248);
if (AESL_DEBUG_TRACE)
