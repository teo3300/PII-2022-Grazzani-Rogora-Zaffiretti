...
// wrapc file define:
#define AUTOTB_TVIN_c "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_c.dat"
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_c.dat"
// wrapc file define:
#define AUTOTB_TVIN_clen "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_clen.dat"
#define AUTOTB_TVOUT_clen "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_clen.dat"
// wrapc file define:
#define AUTOTB_TVIN_m "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_m.dat"
#define AUTOTB_TVOUT_m "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_m.dat"
// wrapc file define:
#define AUTOTB_TVIN_mlen "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_mlen.dat"
#define AUTOTB_TVOUT_mlen "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_mlen.dat"
// wrapc file define:
#define AUTOTB_TVIN_ad "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_ad.dat"
#define AUTOTB_TVOUT_ad "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_ad.dat"
// wrapc file define:
#define AUTOTB_TVIN_adlen "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_adlen.dat"
#define AUTOTB_TVOUT_adlen "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_adlen.dat"
// wrapc file define:
#define AUTOTB_TVIN_nsec "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_nsec.dat"
#define AUTOTB_TVOUT_nsec "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_nsec.dat"
// wrapc file define:
#define AUTOTB_TVIN_npub "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_npub.dat"
#define AUTOTB_TVOUT_npub "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_npub.dat"
// wrapc file define:
#define AUTOTB_TVIN_k "../tv/cdatafile/c.crypto_aead_encrypt.autotvin_k.dat"
#define AUTOTB_TVOUT_k "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_k.dat"
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.crypto_aead_encrypt.autotvout_ap_return.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_c.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_clen "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_clen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_m "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_m.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_mlen "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_mlen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ad "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_ad.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_adlen "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_adlen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_nsec "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_nsec.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_npub "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_npub.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_k "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_k.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.crypto_aead_encrypt.autotvout_ap_return.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" int crypto_aead_encrypt_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, long long, volatile void *, long long, volatile void *, volatile void *, volatile void *);

extern "C" int apatb_crypto_aead_encrypt_hw(volatile void * __xlx_apatb_param_c, volatile void * __xlx_apatb_param_clen, volatile void * __xlx_apatb_param_m, long long __xlx_apatb_param_mlen, volatile void * __xlx_apatb_param_ad, long long __xlx_apatb_param_adlen, volatile void * __xlx_apatb_param_nsec, volatile void * __xlx_apatb_param_npub, volatile void * __xlx_apatb_param_k) {
...
((char*)&AESL_return)[0*4+3] = return_pc_buffer[0].range(31, 24).to_int64();
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > c_pc_buffer(1);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {((char*)__xlx_apatb_param_c)[0*1+0] = c_pc_buffer[0].range(7, 0).to_int64();
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
{
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_m);
...
{
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_ad);
aesl_fh.write(AUTOTB_TVIN_ad, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.ad_depth);
...
{
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_npub);
aesl_fh.write(AUTOTB_TVIN_npub, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.npub_depth);
...
{
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_k);
...
int ap_return = crypto_aead_encrypt_hw_stub_wrapper(__xlx_apatb_param_c, __xlx_apatb_param_clen, __xlx_apatb_param_m, __xlx_apatb_param_mlen, __xlx_apatb_param_ad, __xlx_apatb_param_adlen, __xlx_apatb_param_nsec, __xlx_apatb_param_npub, __xlx_apatb_param_k);
