...
`define AUTOTB_DUT      crypto_aead_encrypt_h
`define AUTOTB_DUT_INST AESL_inst_crypto_aead_encrypt_h
`define AUTOTB_TOP      apatb_crypto_aead_encrypt_h_top
`define AUTOTB_LAT_RESULT_FILE "crypto_aead_encrypt_h.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "crypto_aead_encrypt_h.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_crypto_aead_encrypt_h_top
...
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_c.dat"
`define AUTOTB_TVIN_m_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_m.dat"
`define AUTOTB_TVIN_mlen_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_mlen.dat"
`define AUTOTB_TVIN_ad_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_ad.dat"
`define AUTOTB_TVIN_adlen_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_adlen.dat"
`define AUTOTB_TVIN_npub_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_npub.dat"
`define AUTOTB_TVIN_k_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvin_k.dat"
...
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.crypto_aead_encrypt_h.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvout_c.dat"
`define AUTOTB_TVOUT_clen_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvout_clen.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.crypto_aead_encrypt_h.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
begin
    if(AESL_reset)
        AESL_REG_clen = 0; 
    else if(clen_ap_vld) begin
        AESL_REG_clen <= clen;
        AESL_REG_clen_ap_vld <= 1;
    end
end 

initial begin : write_file_process_clen
    integer fp;
    integer fp_size;
    integer err;
    integer ret;
    ...
    reg [8 * 5:1] str;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVOUT_clen_out_wrapc,"w");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_clen_out_wrapc);
    ...
    while (transaction_idx != AUTOTB_TRANSACTION_NUM) begin
        ...
        if(AESL_REG_clen_ap_vld)  begin
          $fdisplay(fp,"0x%x", AESL_REG_clen);
        AESL_REG_clen_ap_vld = 0;
        end
