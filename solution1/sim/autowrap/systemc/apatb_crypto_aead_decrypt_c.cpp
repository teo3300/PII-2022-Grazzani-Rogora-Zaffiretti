...
// wrapc file define:
#define AUTOTB_TVIN_mlen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_mlen.dat"
#define AUTOTB_TVOUT_mlen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_mlen.dat"
// wrapc file define:
#define AUTOTB_TVIN_nsec "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_nsec.dat"
#define AUTOTB_TVOUT_nsec "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_nsec.dat"
// wrapc file define:
#define AUTOTB_TVIN_c "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_c.dat"
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_c.dat"
// wrapc file define:
#define AUTOTB_TVIN_clen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_clen.dat"
#define AUTOTB_TVOUT_clen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_clen.dat"
// wrapc file define:
#define AUTOTB_TVIN_ad "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_ad.dat"
#define AUTOTB_TVOUT_ad "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_ad.dat"
// wrapc file define:
#define AUTOTB_TVIN_adlen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_adlen.dat"
#define AUTOTB_TVOUT_adlen "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_adlen.dat"
// wrapc file define:
#define AUTOTB_TVIN_npub "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_npub.dat"
#define AUTOTB_TVOUT_npub "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_npub.dat"
// wrapc file define:
#define AUTOTB_TVIN_k "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvin_k.dat"
#define AUTOTB_TVOUT_k "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_k.dat"
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.crypto_aead_decrypt_c.autotvout_ap_return.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_m "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_m.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_mlen "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_mlen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_nsec "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_nsec.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_c.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_clen "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_clen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ad "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_ad.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_adlen "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_adlen.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_npub "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_npub.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_k "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_k.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.crypto_aead_decrypt_c.autotvout_ap_return.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" int crypto_aead_decrypt_c_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, long long, volatile void *, long long, volatile void *, volatile void *);

extern "C" int apatb_crypto_aead_decrypt_c_hw(volatile void * __xlx_apatb_param_m, volatile void * __xlx_apatb_param_mlen, volatile void * __xlx_apatb_param_nsec, volatile void * __xlx_apatb_param_c, long long __xlx_apatb_param_clen, volatile void * __xlx_apatb_param_ad, long long __xlx_apatb_param_adlen, volatile void * __xlx_apatb_param_npub, volatile void * __xlx_apatb_param_k) {
...
{
transaction<8> tr(32);
aesl_fh.read(AUTOTB_TVOUT_PC_m, tr.p, tr.tbytes);
tr.reorder();
tr.send<1>((char*)__xlx_apatb_param_m, 32);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > m_pc_buffer(32);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "m" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 32; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_m)[j*1+0] = m_pc_buffer[i].range(7, 0).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  #endif
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_mlen);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > mlen_pc_buffer(1);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "mlen");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "mlen" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
  
          if (i > 0) {((char*)__xlx_apatb_param_mlen)[0*8+0] = mlen_pc_buffer[0].range(7, 0).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+1] = mlen_pc_buffer[0].range(15, 8).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+2] = mlen_pc_buffer[0].range(23, 16).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+3] = mlen_pc_buffer[0].range(31, 24).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+4] = mlen_pc_buffer[0].range(39, 32).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+5] = mlen_pc_buffer[0].range(47, 40).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+6] = mlen_pc_buffer[0].range(55, 48).to_int64();
((char*)__xlx_apatb_param_mlen)[0*8+7] = mlen_pc_buffer[0].range(63, 56).to_int64();
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
int ap_return = crypto_aead_decrypt_c_hw_stub_wrapper(__xlx_apatb_param_m, __xlx_apatb_param_mlen, __xlx_apatb_param_nsec, __xlx_apatb_param_c, __xlx_apatb_param_clen, __xlx_apatb_param_ad, __xlx_apatb_param_adlen, __xlx_apatb_param_npub, __xlx_apatb_param_k);
CodeState = DUMP_OUTPUTS;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_m, 'b');
transaction<8> tr(32);
  __xlx_offset_byte_param_m = 0*1;
  if (__xlx_apatb_param_m) {
tr.import<1>((char*)__xlx_apatb_param_m, 32, 0);
...
tr.reorder();
aesl_fh.write(AUTOTB_TVOUT_m, tr.p, tr.tbytes);
}
...
// print m Transactions
{
aesl_fh.write(AUTOTB_TVOUT_m, begin_str(AESL_transaction));
{
  __xlx_offset_byte_param_m = 0*1;
  if (__xlx_apatb_param_m) {
    for (int j = 0  - 0, e = 32 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_m)[j];
aesl_fh.write(AUTOTB_TVOUT_m, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
}

  tcl_file.set_num(32, &tcl_file.m_depth);
aesl_fh.write(AUTOTB_TVOUT_m, end_str());
}

#endif
// print mlen Transactions
{
aesl_fh.write(AUTOTB_TVOUT_mlen, begin_str(AESL_transaction));
{
    sc_bv<64> __xlx_tmp_lv = *((long long*)__xlx_apatb_param_mlen);
aesl_fh.write(AUTOTB_TVOUT_mlen, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.mlen_depth);
aesl_fh.write(AUTOTB_TVOUT_mlen, end_str());
}
